...
% 
%     % load the fish of origin
%     fish_ori = load(name_cell{files,1},'fish_ori');
%     fish_ori = fish_ori.fish_ori;
%     
%     % load the single reps
%     single_reps = load(name_cell{files,1},'single_reps');
%     single_reps = single_reps.single_reps;
%     
%     % load the anatomy info
%     anatomy_info = load(name_cell{files,1},'anatomy_info');
...
%     loaded_structure(files).single_reps = single_reps;
%     loaded_structure(files).anatomy_info = anatomy_info;
end
